import 'package:estudando_flutter2/components/centered_message.dart';
...
class TransactionsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Transaction>>(future: _webClient.findAll(), builder: (context, snapshot){
